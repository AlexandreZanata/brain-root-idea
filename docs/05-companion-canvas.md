...
While the Browser destination is selected and no page is open, the Canvas shows a compact destination menu (Browser available; Files, Terminal, and Changes marked as planned) so the empty state stays honest and useful.
