...
allowed = re.compile(
    r"features::(?:"
     ...
     r"|agent_host::(?:AgentHostState|AgentHostStatus|AgentModelList|AgentModelSelection|AgentSendAccepted|AgentStreamEvent|AgentEventEnvelope|AgentConfig|TurnCost|agent_host_start|agent_host_status|agent_host_stop|agent_host_models|agent_host_select_model|agent_host_send|agent_host_cancel_send|agent_host_catalog|agent_host_set_agent|agent_host_turn_cost)"
    r"|health::health"
