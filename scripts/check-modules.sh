...
allowed = re.compile(
    ...
    r"|human_browser::(?:HumanBrowserState|HumanStatus|debug_fixture|human_browser_show|human_browser_navigate|human_browser_back|human_browser_forward|human_browser_reload|human_browser_set_bounds|human_browser_hide|human_browser_status)"
